...
const MusicListItem = (props) => {
  ...
  return (
    <li
      className="item"
      onClick={(e) => selectItem(e, props.item, props.index)}
    >
      <i
        className={classnames("current", {
          "icon-play": props.currentSong.id === props.item.id,
        })}
      />
      <span className="text">{props.item.name}</span>
      <FavoriteButton className="like" song={props.item} />
  ...
  return (
    <div className="list-header">
      <h1 className="title">
        ...
        <span className="clear" onClick={(e) => clearAll(e)}>
...
const PlayList = (props) => {
  ...
  return (
    <>
        ...
        <div className="playlist" onClick={(e) => hidePlaylist(e)}>
          ...
          >
            <ListHeader
              ...
              currentSongName={props.currentSong.name}
            />
            <Scroll
      ...
      {!!showAddSong && <AddSong closeAddSong={() => closeAddSong()} />}
    </>
  );
};
